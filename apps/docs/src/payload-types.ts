...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LexicalNodes_601F10EB".
 */
export type LexicalNodes_601F10EB =
  | SerializedTextNode
  | SerializedTabNode
  | SerializedLineBreakNode
  | SerializedParagraphNode<LexicalNodes_601F10EB>
  ...
  | SerializedQuoteNode<LexicalNodes_601F10EB>
  | SerializedRelationshipNode<
      'users' | 'docs' | 'payload-kv' | 'payload-locked-documents' | 'payload-preferences' | 'payload-migrations'
    >
  | SerializedAutoLinkNode<LexicalNodes_601F10EB, LexicalLinkFields>
  | SerializedLinkNode<LexicalNodes_601F10EB, LexicalLinkFields>
  | SerializedListNode<LexicalNodes_601F10EB>
  | SerializedListItemNode<LexicalNodes_601F10EB>
  | SerializedHeadingNode<LexicalNodes_601F10EB>;
...
export interface Doc {
  ...
  slug: string;
  summary?: string | null;
  content?: LexicalRichText<LexicalNodes_601F10EB> | null;
  updatedAt: string;
  createdAt: string;
}
/**
...
export interface ActivityWidget {
  data?: {
    excludedCollections?: ('users' | 'docs')[] | null;
  };
  width: 'x-small' | 'small' | 'medium' | 'large' | 'x-large' | 'full';
}
/**
